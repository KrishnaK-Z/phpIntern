...
class EventsDelegates
{
  ...
  public function addEvents($datas)
  {
    ...
    $eventObject->setAddressId( $addressDao->getAddressId( $eventObject->getStreetAddress(), $eventObject->getArea(), $eventObject->getPincode())[0]['address_id'] );
